...
Void generateInput (Int32 numSinWaves) {
    Int32 i, j;
...
Int16 y_real_16x16  [N];
Int16 y_imag_16x16  [N];

Int32 y_real_16x32  [N];
Int32 y_imag_16x32  [N];

Int32 y_real_32x32  [N];
Int32 y_imag_32x32  [N];
