...
override PKGDIR = beagle/server/opencv_unitserver_evm3530
...
package/%.xdc.inc package/%_beagle.server.opencv_unitserver_evm3530.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package beagle.server.opencv_unitserver_evm3530" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.executables,64P .executables: opencv_unitserver_evm3530.x64P

package/cfg/opencv_unitserver_evm3530_x64Pcfg_c.c package/cfg/opencv_unitserver_evm3530_x64Pcfg.s62 package/cfg/opencv_unitserver_evm3530_x64Pcfg.cmd: override _PROG_NAME := opencv_unitserver_evm3530.x64P
package/cfg/opencv_unitserver_evm3530_x64Pcfg_c.c package/cfg/opencv_unitserver_evm3530_x64Pcfg.s62 package/cfg/opencv_unitserver_evm3530_x64Pcfg.cmd: override _PROG_XSOPTS =  -Dxdc.cfg.check.fatal=false
-include package/cfg/opencv_unitserver_evm3530_x64P.mak
ifneq (clean,$(MAKECMDGOALS))
-include package/cfg/opencv_unitserver_evm3530_x64P.dep
endif
package/cfg/opencv_unitserver_evm3530/main.o64P package/cfg/opencv_unitserver_evm3530_x64Pcfg.o64P package/cfg/opencv_unitserver_evm3530_x64P.o64P package/cfg/opencv_unitserver_evm3530_x64Pcfg_c.o64P : | package/cfg/opencv_unitserver_evm3530_x64P.xdl
opencv_unitserver_evm3530.x64P: package/cfg/opencv_unitserver_evm3530_x64Pcfg.cmd
opencv_unitserver_evm3530.x64P:
	$(RM) $@
	@$(MSG) lnk64P $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C64P.rootDir)/bin/lnk6x -w -q -u _c_int00 -l link.cmd -q -o $@ package/cfg/opencv_unitserver_evm3530/main.o64P package/cfg/opencv_unitserver_evm3530_x64Pcfg.o64P package/cfg/opencv_unitserver_evm3530_x64P.o64P package/cfg/opencv_unitserver_evm3530_x64Pcfg_c.o64P  package/cfg/opencv_unitserver_evm3530_x64P.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C64P.rootDir)/lib/rts64plus.lib
	
opencv_unitserver_evm3530.x64P:C_DIR=
opencv_unitserver_evm3530.x64P: PATH:=$(ti.targets.C64P.rootDir)/bin/:$(PATH)


ifeq (,$(wildcard .libraries,64P))
opencv_unitserver_evm3530.x64P package/cfg/opencv_unitserver_evm3530_x64P.c: .libraries,64P
endif

package/cfg/opencv_unitserver_evm3530_x64P.c package/cfg/opencv_unitserver_evm3530_x64P.h package/cfg/opencv_unitserver_evm3530_x64P.xdl: override _PROG_NAME := opencv_unitserver_evm3530.x64P
package/cfg/opencv_unitserver_evm3530_x64P.c package/cfg/opencv_unitserver_evm3530_x64P.xdl: override _PROG_XSOPTS =  -Dxdc.cfg.check.fatal=false
package/cfg/opencv_unitserver_evm3530_x64P.c: package/cfg/opencv_unitserver_evm3530_x64P.cfg
opencv_unitserver_evm3530.test test,64P test: opencv_unitserver_evm3530.x64P.test

opencv_unitserver_evm3530.x64P.test:: opencv_unitserver_evm3530.x64P
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 opencv_unitserver_evm3530.x64P.test
else
	@$(MSG) running $<  ...
	$(call EXEC.opencv_unitserver_evm3530.x64P, ) 
endif


clean:: clean,64P
	-$(RM) package/cfg/opencv_unitserver_evm3530_x64P.cfg
	-$(RM) package/cfg/opencv_unitserver_evm3530_x64P.dep
	-$(RM) package/cfg/opencv_unitserver_evm3530_x64P.c
	-$(RM) package/cfg/opencv_unitserver_evm3530_x64P.xdc.inc

clean,64P::
	-$(RM) opencv_unitserver_evm3530.x64P
	-$(RM) .tmp,opencv_unitserver_evm3530.x64P,*

clean:: 
	-$(RM) package/cfg/opencv_unitserver_evm3530_x64P.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
opencv_unitserver_evm3530_x64Pcfg_c.o64P,copy : package/cfg/opencv_unitserver_evm3530_x64Pcfg_c.o64P
opencv_unitserver_evm3530_x64Pcfg.o64P,copy : package/cfg/opencv_unitserver_evm3530_x64Pcfg.o64P
opencv_unitserver_evm3530_x64Pcfg_c.s64P,copy : package/cfg/opencv_unitserver_evm3530_x64Pcfg_c.s64P
opencv_unitserver_evm3530_x64P.o64P,copy : package/cfg/opencv_unitserver_evm3530_x64P.o64P
opencv_unitserver_evm3530_x64P.s64P,copy : package/cfg/opencv_unitserver_evm3530_x64P.s64P
main.o64P,copy : package/cfg/opencv_unitserver_evm3530/main.o64P
main.s64P,copy : package/cfg/opencv_unitserver_evm3530/main.s64P
...
.PHONY: release,beagle_server_opencv_unitserver_evm3530
beagle_server_opencv_unitserver_evm3530.tar: package/build.cfg
beagle_server_opencv_unitserver_evm3530.tar: package/info
beagle_server_opencv_unitserver_evm3530.tar: opencv_unitserver_evm3530.x64P
beagle_server_opencv_unitserver_evm3530.tar: package/package.ext.xml
beagle_server_opencv_unitserver_evm3530.tar: package/package.xdc.inc
beagle_server_opencv_unitserver_evm3530.tar: package/package.bld.xml
beagle_server_opencv_unitserver_evm3530.tar: package/package.rel.dot
ifneq (clean,$(MAKECMDGOALS))
-include package/rel/beagle_server_opencv_unitserver_evm3530.tar.dep
endif
package/rel/beagle_server_opencv_unitserver_evm3530/beagle/server/opencv_unitserver_evm3530/package/package.rel.xml:

beagle_server_opencv_unitserver_evm3530.tar: package/rel/beagle_server_opencv_unitserver_evm3530.xdc.inc package/rel/beagle_server_opencv_unitserver_evm3530/beagle/server/opencv_unitserver_evm3530/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/beagle_server_opencv_unitserver_evm3530.xdc.inc,package/rel/beagle_server_opencv_unitserver_evm3530.tar.dep)


release release,beagle_server_opencv_unitserver_evm3530: all beagle_server_opencv_unitserver_evm3530.tar
clean:: .clean
	-$(RM) beagle_server_opencv_unitserver_evm3530.tar
	-$(RM) package/rel/beagle_server_opencv_unitserver_evm3530.xdc.inc
	-$(RM) package/rel/beagle_server_opencv_unitserver_evm3530.tar.dep
...
ifeq (,$(wildcard package/cfg/opencv_unitserver_evm3530))
    $(shell $(MKDIR) package/cfg/opencv_unitserver_evm3530)
endif
...
clean:: 
	-$(RM) package/beagle.server.opencv_unitserver_evm3530.pjt
