 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /media/disk/OE/work/ti/dsp_opencv/beagle/apps/opencv/cfg/linux/remote_ti_platforms_evm3530/package/cfg/remote_ti_platforms_evm3530_xv5T");
...
String Global_buildInfo[] = {
    ...
    "    package remote_ti_platforms_evm3530 (/media/disk/OE/work/ti/dsp_opencv/beagle/apps/opencv/cfg/linux/remote_ti_platforms_evm3530/) []",
    NULL
};
...
static Engine_Desc engineTab[] = {
    {"opencvEngine",      /* engine name */
      engineAlgs0,    /* alg table */
      "opencv_unitserver_evm3530.x64P",         /* (optional) server name */
...
/* Arm-side DspLink memory map for server "opencv_unitserver_evm3530.x64P":
 *
 ...
 *     synchronized
 */
static Global_ArmDspLinkConfigMemTableEntry armDspLinkConfigMemTable_opencv_unitserver_evm3530_x64P[] = {
...
/* Arm-side DspLink configuration table for server "opencv_unitserver_evm3530.x64P": */
static Global_ArmDspLinkConfig ti_sdo_ce_ipc_armDspLinkConfig_opencv_unitserver_evm3530_x64P = {
    armDspLinkConfigMemTable_opencv_unitserver_evm3530_x64P,
    BootNoPwr
};

/* List of server names for all DspLink configuration tables */
String ti_sdo_ce_ipc_armDspLinkConfigServerNames[] = {
    "opencv_unitserver_evm3530.x64P",
    NULL
};
...
Global_ArmDspLinkConfig *ti_sdo_ce_ipc_armDspLinkConfigs[] = {
    &ti_sdo_ce_ipc_armDspLinkConfig_opencv_unitserver_evm3530_x64P,
    NULL
};
