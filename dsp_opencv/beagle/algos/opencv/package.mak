...
override PKGDIR = beagle/algos/opencv
...
package/%.xdc.inc package/%_beagle.algos.opencv.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package beagle.algos.opencv" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js beagle.algos.opencv $@

.libraries,64P .libraries: lib/opencv_beagle.l64P
...
.PHONY: release,beagle_algos_opencv
beagle_algos_opencv.tar: package/build.cfg
beagle_algos_opencv.tar: package/package.cfg.xdc.inc
beagle_algos_opencv.tar: package/package.ext.xml
beagle_algos_opencv.tar: lib/opencv_beagle.l64P
...
package/rel/beagle_algos_opencv/beagle/algos/opencv/package/package.rel.xml:

beagle_algos_opencv.tar: package/rel/beagle_algos_opencv.xdc.inc package/rel/beagle_algos_opencv/beagle/algos/opencv/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/beagle_algos_opencv.xdc.inc,package/rel/beagle_algos_opencv.tar.dep)


release release,beagle_algos_opencv: all beagle_algos_opencv.tar
clean:: .clean
	-$(RM) beagle_algos_opencv.tar
	-$(RM) package/rel/beagle_algos_opencv.xdc.inc
	-$(RM) package/rel/beagle_algos_opencv.tar.dep
...
ifeq (,$(wildcard package/lib/lib/opencv_beagle))
    $(shell $(MKDIR) package/lib/lib/opencv_beagle)
endif
ifeq (,$(wildcard package/lib/lib/opencv_beagle/package))
    $(shell $(MKDIR) package/lib/lib/opencv_beagle/package)
endif
...
clean:: 
	-$(RM) package/beagle.algos.opencv.pjt
