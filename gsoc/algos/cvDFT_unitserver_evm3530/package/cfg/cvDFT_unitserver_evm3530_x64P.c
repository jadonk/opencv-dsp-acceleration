 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /media/disk/OE/work/ti/my_fir_test/gsoc/algos/cvDFT_unitserver_evm3530/package/cfg/cvDFT_unitserver_evm3530_x64P");
...
String Global_buildInfo[] = {
    ...
    "    package gsoc.algos.cvDFT_unitserver_evm3530 (/media/disk/OE/work/ti/my_fir_test/gsoc/algos/cvDFT_unitserver_evm3530/) [1, 0, 0]",
    NULL
};
...
NODE_Desc RMS_nodeTab[] = {
    ...
    {"cvdft",      {2548591481U},   &UNIVERSAL_SKEL, &nodeAttrs0, 1},
